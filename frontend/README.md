To run the project, install node and npm. Run npm install
This should install all the dependencies necessary ro run the project.

run npm start
This should start a server on port 3000 and open the page automatically.

To develop you also need to install react-scripts
run npm install react-scripts to get your dev environment set up
